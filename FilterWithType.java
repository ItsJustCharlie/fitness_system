...
public class FilterWithType {
    static Scene getFilterActivity()  {
        ...
        filter.setOnAction(e-> {
            updateFilterTable(filteredTableView, typeField);
        });

        HBox hBox= new HBox();
        hBox.getChildren().addAll(typeField, filter);
    ...
    public static void updateFilterTable(TableView<Activity> filteredTableView,  TextField typeField){
        ...
        filteredTableView.setItems(MySqlActivityRepository.selectFilteredEmployeesOnlyType(type));
